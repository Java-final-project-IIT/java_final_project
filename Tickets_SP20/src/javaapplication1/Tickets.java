...
public class Tickets extends JFrame implements ActionListener {
	...
	JScrollPane sp3;
	JScrollPane sp4;
	boolean spFlg,sp1Flg,sp3Flg,sp4Flg;
...
<<<<<<< HEAD:Tickets_SP20/src/javaapplication1/Tickets.java
...
=======
			...
			int id = dao.insertRecords(ticketName, ticketDesc);
			int w = dao.insertWorkers(workerName, workerID);
>>>>>>> 87ac659771824f78082e9c38cd12cb8fa5a8d045:final_project/Mahmood(demo)/src/javaapplication1/Tickets.java
...
>>>>>>> 87ac659771824f78082e9c38cd12cb8fa5a8d045:final_project/Mahmood(demo)/src/javaapplication1/Tickets.java
...

		{
			...
			// display results if successful or not to console / dialog box
			if (id2 == Integer.parseInt(ticket_id)) {
